...
let projectYelpCamp =
{
    ...
    link : "#",
    carouselItems : [
        '<img src="./assets/imgs/yelpCamp1.png" alt="">',
        '<img src="./assets/imgs/yelpCamp2.png" alt="">',
        '<img src="./assets/imgs/yelpCamp3.png" alt="">'
    ]
};
...
function populateProjectDetails(project)
{
    ...
    var info = `<h3>${project.title}</h3>`;
    info += `<p>${project.explanation}</p>`;
